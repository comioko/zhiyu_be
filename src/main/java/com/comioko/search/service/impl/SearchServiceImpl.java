package com.comioko.search.service.impl;
...
import com.comioko.search.api.dto.SearchResponse;
import com.comioko.search.api.dto.SuggestResponse;
import com.comioko.search.service.SearchService;
...
public class SearchServiceImpl implements SearchService {
     ...
     * ES 索引名：zhiyu 内容统一索引。
     */
    private static final String INDEX = "zhiyu_content_index";
            ...
            resp = es.search(s -> {
                var b = s.index(INDEX)
                        ...
                        .highlight(h -> h
                                ...
                                .fields("body", new HighlightField.Builder().build())
                        )
                        .sort(sorts);
