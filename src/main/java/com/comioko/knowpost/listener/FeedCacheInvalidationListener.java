package com.comioko.knowpost.listener;

import com.fasterxml.jackson.core.type.TypeReference;
import com.comioko.counter.event.CounterEvent;
import com.github.benmanes.caffeine.cache.Cache;
import com.comioko.knowpost.api.dto.FeedItemResponse;
...
public class FeedCacheInvalidationListener {
    ...
    private final com.comioko.knowpost.mapper.KnowPostMapper knowPostMapper;

    public FeedCacheInvalidationListener(@Qualifier("feedPublicCache") Cache<String, FeedPageResponse> feedPublicCache,
                                         StringRedisTemplate redis,
                                         ObjectMapper objectMapper,
                                         com.comioko.counter.service.UserCounterService userCounterService,
                                         com.comioko.knowpost.mapper.KnowPostMapper knowPostMapper) {
