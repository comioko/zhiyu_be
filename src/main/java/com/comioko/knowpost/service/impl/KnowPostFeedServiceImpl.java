package com.comioko.knowpost.service.impl;
...
import com.comioko.knowpost.model.KnowPostFeedRow;
...
public class KnowPostFeedServiceImpl implements KnowPostFeedService {
    ...
    public FeedPageResponse getPublicFeed(int page, int size, Long currentUserIdNullable) {
        ...
        synchronized (lock) {
            ...
            //这里查询比一页多一个的数量，来判断是否有下一页，比如现在一页20条，执行的操作是查21条，如果查到了21条，说明有下一页。
