...
public class OssStorageService {
    ...
    public String uploadAvatar(long userId, MultipartFile file) {
        ...
        OSS client = new OSSClientBuilder().build("https://" + props.getEndpoint(), props.getAccessKeyId(), props.getAccessKeySecret());
