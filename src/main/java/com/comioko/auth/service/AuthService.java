package com.comioko.auth.service;

import com.comioko.auth.api.dto.*;
import com.comioko.auth.audit.LoginLogService;
import com.comioko.auth.config.AuthProperties;
import com.comioko.auth.model.ClientInfo;
import com.comioko.auth.model.IdentifierType;
import com.comioko.auth.token.JwtService;
import com.comioko.auth.token.RefreshTokenStore;
import com.comioko.auth.token.TokenPair;
import com.comioko.auth.util.IdentifierValidator;
import com.comioko.auth.verification.*;
...
import com.comioko.user.service.UserService;
...
public class AuthService {
    ...
    public AuthResponse register(RegisterRequest request, ClientInfo clientInfo) {
        ...
        User user = User.builder()
                ...
                .avatar("https://static.zhiyu.cn/default-avatar.png")
                .bio(null)
                .tagsJson("[]")
                .build();
        //校验密码，设置密码
    ...
    private String generateNickname() {
        return "知域用户" + UUID.randomUUID().toString().substring(0, 8);
    }
